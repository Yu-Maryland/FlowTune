...
/*=== abcBayestune.cpp ==========================================================*/
extern ABC_DLL void bayes_flow_tune(char* design, int repeats, int prefix_pos, int target, int nSamples, int mab_iter, int fForget, int fSoftmax, char* lib, char* opts);
